                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <a class="visitas">41 Visitas Ativas</a>
                                    </div>
                                </div>                                                          
                            </div>                            
                        </div>
                                                ...
                                                <div class="col-12" id="cadastrar_estrangeiro">
                                                        ...
                                                        <div class="form-group position-relative">
                                                            <select class="form-select" name="nacionalidade" id="nacionalidade"> 
                                                                ...
                                                                <?php while($rows = mysqli_fetch_array($result)){ ?>
                                                                    <option value="<?=$rows['nome']?>"><?=utf8_encode($rows['nome'])?></option>                                                                                                                                                                                                                             
                                                                <?php } ?>
                                                            </select>  
                                                        </div>                                        
                                                    </div> 
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12"> 
                                                            ...
                                                            <div class="form-group position-relative">
                                                                <textarea class="form-control" rows="3" name="pesquisaint" id="pesquisaint"></textarea>
                                                            </div>     
                                                        </div> 
                                                    </div>                                                                                                        
                                                    ...
                                                    <div class="mb-3">
                                                        <h6>Anexar Termo</h6>    
                                                        <input class="form-control" type="file" id="termo" name="termo"> 
                                                    </div>
                                                </div>                                                
